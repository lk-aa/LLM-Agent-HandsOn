"""
bilibili_api.bili_server.safecenter_captcha
...
def _start_server(urlhandler, hostname, port):
    """Start an HTTP bili_server thread on a specific port.
    ...
    class ServerThread(threading.Thread):
        ...
        def stop(self):
            """Stop the bili_server and this thread nicely"""
