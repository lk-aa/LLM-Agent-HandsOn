...
if __name__ == "__main__":
    ...
    # print(type(res))
    r = res[0]
    print(type(r.page_content))
    print(type(r.metadata))
    print("论文摘要: ", r.page_content)  
    print("论文标题：", r.metadata["Title"])
    print("论文作者：", r.metadata["Authors"])
    print("论文最后更新时间：", r.metadata["Published"])
    print("论文首次发布日期：", r.metadata["published_first_time"])
    print("论文注释：", r.metadata["comment"])
    print("论文链接：", r.metadata["Entry ID"])
    print("论文分类：", r.metadata["primary_category"])
